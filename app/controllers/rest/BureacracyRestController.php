...
class BureacracyRestController extends BaseController {
	

	public function getTerms()
	{
		$text = '<h2>Terms of Service</h2>
			<p>
				...
				The Services allow the users  - by the mean of collecting 
			...
			<p>
				...
				in accordance with the terms and conditions laid down in this 
				document. The regulation of the relationships 
				between Oboli and the User may also include supplementary 
			...
			<p>
				...
				a) by clicking on the option that grants 
				the acceptation of the terms, where this option is made available  
			...
			<p>
				...
				agrees that the translation is provided for his
				 ...
				 of the Terms will govern his relationship with Oboli, 
				 and if there is any contradiction between the English version 
			...
			<p>
				...
				his guest profile by adding in the custom settings of his profile a 
				custom nickname. For this purpose,  the user will be able to use the 
				main window of Oboli in order to run the registration process of his 
				own profile on the Oboli platform (i.e. website and /or App)  by 
				inserting his own data necessary and qualifiable as non-sensitive data, 
				below indicated: a) email b) nickname c)password d) age e) gender.
				In addition the User will be able to decide whether to add in the 
				settings of his profile a photo related to his profile (avatar). 
				The backup of the user data is operated on the Oboli servers and Oboli 
				is liable for the conservation of the data provided. To this purpose, the 
				user, during the registration process, shall be informed through a dedicated 
			...
			<p>
				...
				and networks which are connected to the Services). Unless 
				specifically permitted to do so in a separate agreement with 
				Oboli, the User agrees that he will not reproduce, duplicate, 
				copy, sell, trade or resell the Services for any purpose. The 
				User agrees that he is solely responsible for (and that Oboli 
				has no responsibility to him or to any third party) for any 
				breach of his obligations under the Terms and for the 
				consequences (including any loss or damage which Oboli may suffer) 
				of any such breach.
				The obligations included in this agreement are in any 
			...
			<p>
				...
				which the User may have access as part of, or through his 
				use of, the Services are the sole responsibility of the 
				person from which such content originated. All such 
				information is referred to below as the “Contents”
				The User must be aware that Contents presented 
				as part of the Services, including but not limited 
				to advertisements in the Services may be protected 
				by intellectual property rights which are owned by 
				the sponsors or advertisers who provide that Content 
				to Oboli (or by other persons or companies on their behalf). 
				It is forbidden to modify, rent, lease, loan, sell, 
				distribute or create derivative works based on this 
				Content (either in whole or in part) unless specifically 
				permitted to do so by Oboli or by the owners of that 
				Contents in a separate agreement.
				Oboli reserves the right (but shall have no obligation) 
				to review, label, filter, modify, refuse or remove 
				all or part of the Contents from any Service. 
				User acknowledges that, by using the Services, 
				he could be exposed to Contents considered offensive, 
				indecent or controversial and that, for that purpose, 
				he uses the Services  at his own risk.
				The User agrees that he is solely responsible for 
				(and that Oboli has no responsibility to him or to any third party 
				for) any Content that he creates, transmit or display while using 
			...
			<p>
				...
				subsist in the Services (whether those rights 
				happen to be registered or not, and wherever in 
				the world those rights may exist).
				Nothing in the Terms entitles the User to use any 
				trade name, trademark, service mark, logo, domain 
				name or other distinctive signs of Oboli.
				Oboli acknowledges and agrees that it obtains 
				from its  partners and users (or from its licensees) 
				no right, title or interest, under these Terms in or 
				to any Contents submitted, published, transmitted or 
				displayed by the partner on or through the Services, 
				including any intellectual property rights which subsists 
				in that Content (whether those rights happen to be registered 
				or not, and wherever in the world those rights may exist). 
				Unless otherwise agreed in writing with Oboli, 
				User agrees that he is the solely responsible for 
				protecting and enforcing these rights and that Oboli 
				has no obligation to do so on behalf of User. 
				The Parties agree that Oboli has the right to use 
				freely and without any charge, also through its internet 
				website and/or mobile App, the name, the logo and generally 
				the distinctive features of the User only for the purposes 
				related to this agreement and for the purposes of displaying 
				its services to potential users.
				The users agree not to remove, hide or alter any notification 
				related to the property rights (including notices related 
				to the copyright and the trademarks) possibly displayed or 
				included in the Services.
				Unless expressly authorized in writing by Oboli to do so, 
				the User agrees that in using the Services, he will not 
				use any trade mark, service mark, trade name, logo of any 
				company or organization in a way that is likely or intended 
			...
			<p>
				...
				"AS IS" AND “AS AVAILABLE.”IN PARTICULAR, OBOLI, 
				ITS SUBSIDIARIES AND AFFILIATES, AND ITS 
				LICENSORS DO NOT REPRESENT OR WARRANT THAT: 
				(A) THE USE OF THE SERVICES BY THE USER WILL 
				MEET HIS REQUIREMENTS; (B)THE USE OF THE SERVICES 
				BY THE USER WILL BE UNINTERRUPTED, TIMELY, 
				SECURE OR FREE FROM ERROR; (C) ANY INFORMATION 
				OBTAINED BY THE USER AS A RESULT OF HIS USE 
				OF THE SERVICES WILL BE ACCURATE OR RELIABLE, 
				AND (D) THE DEFECTS IN THE OPERATION OR FUNCTIONALITY 
			...
			<p>
				...
				(A) ANY DAMAGE CONSEQUENTIAL TO THE USE OF THE SERVICES. 
				...
				OF DATA SUFFERED BY THE USER, COST OF PROCUREMENT OF 
				SUBSTITUTE GOODS OR SERVICES, OR OTHER INTANGIBLE LOSS; 
				(B) ANY LOSS OR DAMAGE WHICH MAY BE INCURRED BY THE USER, 
				INCLUDING BUT NOT LIMITED TO LOSS OR DAMAGE AS A RESULT 
				OF: C) ANY RELIANCE PLACED BY THE USER ON THE COMPLETENESS, 
				ACCURACY OR EXISTENCE OF ANY ADVERTISING, OR AS 
				A RESULT OF ANY RELATIONSHIP OR TRANSACTION BETWEEN 
				THE USER AND ANY ADVERTISER OR SPONSOR WHOSE 
				ADVERTISING APPEARS ON THE SERVICES; (D) ANY CHANGES 
				WHICH OBOLI MAY MAKE TO THE SERVICES, OR FOR ANY 
				PERMANENT OR TEMPORARY CESSATION IN THE PROVISION OF 
				THE SERVICES (OR ANY FEATURES WITHIN THE SERVICES); 
				(E) THE DELETION OF, CORRUPTION OF, OR FAILURE TO STORE, 
			...
			<p>
				...
				The manner, mode and extent of advertising by Oboli 
				on the Services are subject to change without 
				specific notice to the User.
				In consideration for Oboli granting to the User 
			...
			<p>
				...
				The User understands and agrees that if he use the Services 
			...
			<p>
				...
				which are provided by another person or company. 
				The use by the User of these other services, software or 
				goods may be subject to separate terms between you and 
				the company or person concerned. If so, the Terms do not 
				affect your legal relationship with these other companies 
				or individuals.
				The User agrees that Oboli may provide you with notices, 
				including those regarding changes to the Terms, by email, 
				regular mail, or postings on the Services.
				The Terms represent the entire agreement between Oboli and 
				the User.  The Terms repeal and replace any former agreement,
				 in writing or orally, between the Parties on the matters 
				 which they regulate. There are no agreements in writing 
				 or orally which provide for derogations from the Terms 
				 for the use of the Services.
				If one of the provisions of the Terms may result invalid 
				and/or ineffective, the other provisions of the 
				Terms unaffected by such flaws will stay legally 
				binding and be valid and enforceable.
				The Terms do not constitute any form of association 
				between the Parties and therefore, each one of them 
			...
			<p>
				...
				but not limited to, attorneys fees and expenses, arising 
				out a breach by the User or any user of your account of 
				these terms and conditions or privacy policy or arising 
			...
			<p>
				...
				those related to the interpretation, to the validity 
				or to the termination of the agreement between the parties, 
