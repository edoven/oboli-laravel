                                ...
                                <div class="carousel slide carousel-fade">
                                    <div class="carousel-inner">
                                        ...
                                        <div class="item active">       
                                            <span class="text-big">We are creating a<br>better world<br>with your help</span><br>
                                        ...
                                        <!-- item 2  -->
                                        <div class="item">       
                                            <span class="text-big">Make an impact!<br>it's free<br>and it's simple</span><br>
		  ...
		  <section id="ngos">
			...
			<div class="inner-container overlay-light row-of-columns">
				...
				<div class="row">
								...
								<div class="item active">
									<div class="panel ngo">
										...
										<div class="panel-body">
											<h3><a href="sample-campaign.html">Amnesty International</a></h3>
					...
					<!-- element 2/3-->
					<div class="col-sm-4 ">
						<div class="" id="carousel_3">
							<div class="carousel-inner">
								<div class="item active">
									<div class="panel ngo">
										<div class="panel-header">
											<a href="sample-campaign.html">
												<img src="{{ asset('bootstrap/img/hrw.png') }}" class="img-responsive col-xs-12 no-padding"  alt="image"/><!-- / css hack: 'col-xs-12 no-padding' added as workaround due to image not resizing once responsive col kicks in -->
											</a>
											<div class="clearfix"></div>
										</div>
										<div class="panel-body">
											<h3><a href="sample-campaign.html">Human Rights Watch</a></h3>
											<p>Nam consequat lacus purus, ac hendrerit ipsum pellentesque ut. Mauris orci ante, sodales ut lorem sed, semper aliquam diam. Sit amet tellus velit.</p>
											<div class="col-lg-12 no-padding">
												<div class="progress progress-xs">
													<div class="progress-bar progress-bar-tertiary" role="progressbar"  aria-valuenow="60" aria-valuemin="0" aria-valuemax="60" style="width:50%"></div>
							...
							<div class="carousel-inner">
								<div class="item active">
									<div class="panel ngo">
										<div class="panel-header">
											<a href="sample-campaign.html">
												<img src="{{ asset('bootstrap/img/wwf.png') }}" class="img-responsive col-xs-12 no-padding"  alt="image"/><!-- / css hack: 'col-xs-12 no-padding' added as workaround due to image not resizing once responsive col kicks in -->
											</a>
											<div class="clearfix"></div>
										</div>
										<div class="panel-body">
											<h3><a href="sample-campaign.html">WWF</a></h3>
											<p>Nam consequat lacus purus, ac hendrerit ipsum pellentesque ut. Mauris orci ante, sodales ut lorem sed, semper aliquam diam. Sit amet tellus velit.</p>
											<div class="col-lg-12 no-padding">
												<div class="progress progress-xs">
													<div class="progress-bar progress-bar-tertiary" role="progressbar"  aria-valuenow="60" aria-valuemin="0" aria-valuemax="60" style="width:50%"></div>
							...
							<div class="carousel-inner">
								<div class="item active">
									<div class="panel ngo">
										<div class="panel-header">
											<a href="sample-campaign.html">
												<img src="{{ asset('bootstrap/img/stc.png') }}" class="img-responsive col-xs-12 no-padding"  alt="image"/><!-- / css hack: 'col-xs-12 no-padding' added as workaround due to image not resizing once responsive col kicks in -->
											</a>
											<div class="clearfix"></div>
										</div>
										<div class="panel-body">
											<h3><a href="sample-campaign.html">Save the Children</a></h3>
											<p>Nam consequat lacus purus, ac hendrerit ipsum pellentesque ut. Mauris orci ante, sodales ut lorem sed, semper aliquam diam. Sit amet tellus velit.</p>
											<div class="col-lg-12 no-padding">
												<div class="progress progress-xs">
													<div class="progress-bar progress-bar-tertiary" role="progressbar"  aria-valuenow="60" aria-valuemin="0" aria-valuemax="60" style="width:50%"></div>
							...
							<div class="carousel-inner">
								<div class="item active">
									<div class="panel ngo">
										...
										<div class="panel-body">
											<h3><a href="sample-campaign.html">Enrichment Camps</a></h3>
											<p>Nam consequat lacus purus, ac hendrerit ipsum pellentesque ut. Mauris orci ante, sodales ut lorem sed, semper aliquam diam. Sit amet tellus velit.</p>
											<div class="col-lg-12 no-padding">
												<div class="progress progress-xs">
													<div class="progress-bar progress-bar-tertiary" role="progressbar"  aria-valuenow="60" aria-valuemin="0" aria-valuemax="60" style="width:50%"></div>
         ...
         <section id="volunteer">
         	<div class="overlay-dark">
                    <div class="col-md-7 inner-container wow animated fadeIn pull-right ">
                        ...
                        <br><br>
                        <button class="btn btn-black">Volunteer Now</button>
                    </div>
            </div><!-- /end overlay -->
