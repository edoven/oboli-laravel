...
(function() {
    ...
    var myLatlng = new google.maps.LatLng(51.5286416, -0.1015987); // New York
    function init() {
        ...
        var contentString = '<div id="content">' +
            ...
            '<h4><i class="fa fa-car text-primary"></i>&nbsp;&nbsp;&nbsp;&nbsp;<b>London, UK</b></h4>' +
            '<h4><i class="fa fa-envelope text-primary"></i>&nbsp;&nbsp;&nbsp;&nbsp;<b>info@getoboli.com</b></h4>' +
            '<h4><i class="fa fa-send text-primary"></i>&nbsp;&nbsp;&nbsp;&nbsp;<b>543.999.1463</b></h4><br>' +
            '<p>Interested in join Oboli as NGO? Inquiring about job open positions?<br>Just want to chat about an idea or give a feedback? We would love to hear from you!</p>' +
            '</div>' +
            '</div>';
